...
PUBLISHED_TABLE: tuple[PublishedRow, ...] = (
    PublishedRow("Accuracy", frozenset({"I"}), 91, 0.18884597898784045, 10, 41, 0.005),
    PublishedRow("F1 Score", frozenset({"I"}), 72, 0.14062183186849211, 2, 9, 0.005),
    PublishedRow("mAP", frozenset({"I"}), 45, 0.3111319305252532, 2, 4, 0.005),
    PublishedRow("Storage Size", frozenset({"SP"}), 100, 1.7785578074364585e-08, 17, 62, 5e-10),
    PublishedRow("GPU Utilization", frozenset({"I", "WP"}), 97, 0.0, 2, 3, 1e-12),
    PublishedRow("GPU Power Draw", frozenset({"I", "WP"}), 98, 0.29835399999999995, 3, 5, 0.005),
    ...
    PublishedRow("Inference Latency", frozenset({"P", "SP"}), 100, 0.32869212132935427, 12, 51, 0.005),
)
